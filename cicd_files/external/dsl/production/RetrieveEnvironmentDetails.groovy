...
def pipelineBeingGeneratedName = 'RPT-RC_Retrieve-Environment-Details'

pipelineJob(pipelineBeingGeneratedName) {
    description(commonSteps.defaultJobDescription(pipelineBeingGeneratedName,
        "This Job is to retrieve the properties of a test environment in RPT.",
        "cicd_files/external/dsl/production/RetrieveEnvironmentDetails.groovy",
        "cicd_files/external/jenkins/production/RetrieveEnvironmentDetails.Jenkinsfile"
    ))
    ...
    definition {
        cpsScm {
            ...
            scriptPath('cicd_files/external/jenkins/production/RetrieveEnvironmentDetails.Jenkinsfile')
        }
    }
}
